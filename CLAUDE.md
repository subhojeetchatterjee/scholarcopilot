...
- Current task: Step 9 (/api/explain)
- Do not revisit completed steps unless explicitly asked

## Important rule
- The deterministic match engine is the source of truth
- Claude explains results; Claude does not decide eligibility from scratch
## Files to read first
- types/index.ts
- lib/matchEngine.ts
...
- app/scholarship/[id]/page.tsx
## Next task
Implement app/api/explain/route.ts only